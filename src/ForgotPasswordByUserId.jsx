...
export default function ForgotPasswordByUserId({ onBackToLogin, onBackToHome, onBackToEmailReset }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setErrors({ general: 'Failed to process reset request. Please try again.' });
        } finally {
            setIsLoading(false);
        }
    };
                ...
                <div className="flex-1 flex items-center justify-center px-4">
                    <div className="bg-white rounded-2xl shadow-lg p-12 w-full max-w-md text-center">
                        <div className="mb-6">
                            ...
                            <h1 className="text-2xl font-semibold text-gray-800 mb-4">Reset Request Sent!</h1>
                            <p className="text-gray-600 mb-6">
                                We've processed your password reset request for User ID: <br />
                                <span className="font-medium">{userId}</span>
                            </p>
                            <p className="text-sm text-gray-500">
                                Please contact your system administrator or check your registered email for further instructions.
                            </p>
                        </div>
            ...
            <div className="flex-1 flex items-center justify-center px-4">
                <div className="bg-white rounded-2xl shadow-lg p-12 w-full max-w-md">
                    ...
                    <p className="text-gray-600 text-sm mb-8">
                        Enter your User ID to receive a new password and reset your password.
                    </p>
